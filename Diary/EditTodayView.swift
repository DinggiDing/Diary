...
//    init(title: Binding<String>, maintext: Binding<String>, isPresented: Binding<Bool>, isHiding: Binding<Bool>) {
//        self._title = title
                        ...
                        ScrollView {
                            VStack(alignment: .center, spacing: 24) {
                                ...
                                HStack {
                                    ...
                                    TextField("", text: $title, axis: .vertical)                                        .font(.Arita_buriBold_edt)
...
//                                        
//                                        /// typing focus scroll
//                                            .onChange(of: db.status) { _ in
//                                                proxy.scrollTo("texteditorda", anchor: .bottom)
//                                            }
//        
//                                        if db.status.isEmpty {
//                                            VStack {
//                                                Text("Empty")
